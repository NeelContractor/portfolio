...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/NeelContractor",
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://in.linkedin.com/in/neel-contractor-695400164",
        icon: Icons.linkedin,
      ...
      X: {
        name: "X",
        url: "https://x.com/NeelContractor1",
        icon: Icons.x,
      ...
      resume: {
        name: "Resume",
        url: "https://docs.google.com/document/d/1IQG3vdd_m-3DZqm4cSF9QOqc52gWzMIxnlo1N9k7zc8/edit?usp=sharing",
  ...
  hackathons: [
    {
      title: "100xDevs Mini Hackathon",
      dates: "2025",
      location: "Online",
      description:
        "Recognized for excellence in building innovative decentralized solutions",
      image:
        "/100xdevs.png",
      ...
      links: [
        {
          ...
          href: "https://earn.superteam.fun/feed/submission/d5916dac-e084-4df0-8d07-30da37731662",
        },
        {
          title: "Github",
          icon: <Icons.github className="h-4 w-4" />,
          href: "https://github.com/NeelContractor/timevault",
        },
      ],
    },
    // {
